...
export default class Account extends React.Component  {
    ...
    cancelTicket = (e,item) => {
        ...
        fetch('http://54.159.225.120:8080/cancelTicket', requestOptions).then(response => response.json())
            .then(json => {
    ...
    fetchTravelHistory = (e) => {
        ...
        fetch('http://54.159.225.120:8080/getUserTrips', requestOptions).then(response => response.json())
            .then(json => {
                this.setState({
                    tableData: json
                });
